...
_
    entries => [
        ...
        {module=>"Validate::Simple", summary=>"From 0.01 to 0.01.1", date=>"2020-01-01", author=>"ANDREIP"},
        {module=>"Bencher", summary=>"From 0.46 to 0.46.1", date=>"2016-03-31", author=>"PERLANCAR"},
        {module=>"Acme::CPANLists", summary=>"From 0.02 to 0.9.0", date=>"2015-10-23", author=>"PERLANCAR"},
    ],
};
